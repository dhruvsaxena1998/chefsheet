      ...
      const getData = async () => {
        try {
          const {
            ...
            `${backendURL}/admin/registration-info?registrationToken=${registrationToken}`
          );
          ...
          onSubmit={async (data, formik) => {
            try {
              ...
              if (registrationToken) {
                ...
                onSubmit(
                  {
                    userInfo: omit(data, ["registrationToken"]),
                    registrationToken,
                  },
                  formik
                );
                ...
                <Main>
                  ...
                  <Stack spacing={6}>
                    ...
                    <TextInput
                      ...
                      onChange={handleChange}
                      error={
                        errors.email ? formatMessage(errors.email) : undefined
                      }
                      required
                      label={formatMessage({
